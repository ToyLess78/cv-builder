...
const EditEducation: FC = () => {
    ...
    const educationState = useSelector((state: RootState) => selectEducation(state));
    ...
    const [educationItem, setEducationItem] = useState(data.find(item => item.id === editedId) || newEducation);
    ...
    useEffect(() => {
        duration && !educationItem.isPresent && setEducationItem({
            ...educationItem,
    ...
    useEffect(() => {
        isPresent && educationItem.duration &&
        ...
        <MainEditWrapper
            ...
            preview={
                <Education educationItem={ educationItem }>
                    <BreezeTitle text={ educationState.title }/>
                </Education>
            }
            edit={
                <>
                    <div className={ styles.inputs }>
                        <UnderlineInput
                            ...
                            onChange={ (e) => setEducationItem({...educationItem, degree: e.currentTarget.value}) }
                        />
                        <UnderlineInput
                            label="school"
                            value={ educationItem.school }
                            onChange={ (e) => setEducationItem({...educationItem, school: e.currentTarget.value}) }
                        />
                    </div>
                    <div className={ styles.inputs }>
                        ...
                        <UnderlineInput
                            ...
                            onChange={ (e) => setEducationItem({...educationItem, location: e.currentTarget.value}) }
                        />
                    </div>
