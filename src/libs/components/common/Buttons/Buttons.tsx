...
export const HideButton: React.FC<IEditButtonProps> = ({
	onClick,
	title,
	offset = 20,
	style = { top: "1.3rem" },
...
export const UploadButton: React.FC<IEditButtonProps> = ({
	onClick,
	offset = 0,
}) => {
	return (
...
export const ShowButton: React.FC<IEditButtonProps> = ({
	onClick,
	title,
	offset = 0,
}) => {
...
export const AddItemButton: React.FC<IEditButtonProps> = ({
	onClick,
	title,
	offset = 20,
	style = { bottom: "0" },
...
export const MoreButton: React.FC<IEditButtonProps> = ({
	onClick,
	offset = -15,
}) => {
	return (
...
export const ReturnButton: React.FC<IEditButtonProps> = ({
	onClick,
	title,
}) => {
	return (
...
export const EditButtonsBox: React.FC<IEditButtonsBoxProps> = ({
	onRemove,
	onEdit,
	removeStyle,
	editeStyle,
