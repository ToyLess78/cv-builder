...
const EditCertificates = lazy(
	() => import("~/components/modules/certifications/EditCertifications"),
);
const EditSummary = lazy(
	() => import("~/components/modules/header/EditSummary"),
);
...
const EditLanguage = lazy(
	() => import("~/components/modules/languages/EditLanguage"),
);
const EditContacts = lazy(
	() => import("~/components/modules/contacts/EditContacts"),
);
const EditExperience = lazy(
	() => import("~/components/modules/experience/EditExperience"),
);
const EditEducation = lazy(
	() => import("~/components/modules/education/EditEducation"),
);
const EditProjects = lazy(
	() => import("~/components/modules/projects/EditProjects"),
);
