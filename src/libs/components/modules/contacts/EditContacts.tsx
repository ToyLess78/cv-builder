...
import { AsideItem, CheckBox, CollapsedWrapper, Contacts, EditWrapper, Title, UnderlineInput } from '~/components';
...
const EditContacts: React.FC<{isShare?: boolean}> = ({isShare = false}) => {
    ...
    const isIcons = (template === TemplateConstants.Headway || template === TemplateConstants.Advance || template === TemplateConstants.Success || template === TemplateConstants.Modern);
